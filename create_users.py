...
def create_users():
    ...
    iam.put_group_policy(group, group + "_Policy", policy_json)


    # add users to group
    with open('users.csv', 'rU') as users_file:
        user_reader = csv.reader(users_file)
...
def delete_users():
    ...
    iam.delete_group_policy(group, group + "_Policy")
